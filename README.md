...
-----
### Contact Info
personal email: lind.brandon.m@gmail.com

academic email: brandon.lind@ubc.ca

github: https://www.github.com/brandonlind
...
1. [Jack pine GEA populations (in progress)](https://github.com/brandonlind/jack_pine_mapping_pops_analyses)
    - This repository contains the processessing scripts needed to analyze range-wide populations of jack pine.

1. [CoAdapTree Douglas-fir / lodgepole pine SNP array (in progress)](https://github.com/brandonlind/coadaptree_snparray)
    - This repository covers the code used to develop a 50k SNP array split evenly between Douglas-fir and lodgepole pine.

-----
### Publications and associated repositories
1. (2021) BM Lind*, M Lu*, D Vidakovic, P Singh, T Booker, S Yeaman, S Aitken. Haploid, diploid, and pooled exome capture recapitulate features of biology and paralogy in two non-model tree species. Molecular Ecology Resources. [Direct Link](https://onlinelibrary.wiley.com/doi/10.1111/1755-0998.13474) or [Download](pdfs/Lind_et_al_2021-Haploid-diploid-and-pooled-exome-capture-recapitulate-features-of-biology-and-paralogy-in-two-non-model-tree-speces.pdf)
    - <b> Abstract </b>
